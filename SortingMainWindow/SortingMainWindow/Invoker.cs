...
namespace SortingMainWindow
{
    static class Invoker
    {
        ...
        private delegate void _ChangeText(Control ctrl, string msg);
        ...
        public static void ChangeText(Control cntrl, string msg)
        {

            if (cntrl.InvokeRequired)
            {
                cntrl.Invoke(new _ChangeText(ChangeText), cntrl, msg);
            }
            else
            {
                cntrl.Text = msg;
